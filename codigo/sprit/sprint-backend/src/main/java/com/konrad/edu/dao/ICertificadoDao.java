...
public interface ICertificadoDao extends CrudRepository<CertificadoEntity, Long> {
	...
	public CertificadoEntity findByNumeroHistoria(@Param("seq_historia") Long seqHistoria);
